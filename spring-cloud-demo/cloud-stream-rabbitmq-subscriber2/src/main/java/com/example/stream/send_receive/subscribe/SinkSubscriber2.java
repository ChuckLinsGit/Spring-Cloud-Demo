...
public class SinkSubscriber2 {
    private static Logger logger= LoggerFactory.getLogger(SinkSubscriber2.class);
    ...
    public void receive(Object playload){
        logger.info("Receiver2: "+playload.getClass()+"--"+playload);
    }
